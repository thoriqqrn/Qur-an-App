...
class AudioManager {
  ...
  static void playSound({required String url}) async {
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  color: nav, borderRadius: BorderRadius.circular(10)),
              child: Row(
                children: [
                  Container(
                    width: 27,
                  ...
                  GestureDetector(
                    onTap: () {
                      AudioManager.playSound(
                          url:
                              "https://equran.nos.wjv-1.neo.id/audio-full/Misyari-Rasyid-Al-Afasi/00$noSurat.mp3");
                    },
                    child: const Icon(
